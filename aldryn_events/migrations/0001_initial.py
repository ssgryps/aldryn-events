    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(null=True, blank=True, to=settings.AUTH_USER_MODEL, unique=True, verbose_name='user', on_delete=models.deletion.CASCADE,)),
            ],
            options={
            },
            bases=(models.Model,),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('master', models.ForeignKey(related_name='translations', editable=False, to='aldryn_events.Event', null=True, on_delete=models.deletion.CASCADE,)),
            ],
            options={
                'abstract': False,
