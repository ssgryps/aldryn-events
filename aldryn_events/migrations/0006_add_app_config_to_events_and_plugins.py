    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('master', models.ForeignKey(related_name='translations', editable=False, to='aldryn_events.EventsConfig', null=True, on_delete=models.deletion.CASCADE,)),
            ],
            options={
                'managed': True,
        ...
        migrations.AddField(
            ...
            name='app_config',
            field=models.ForeignKey(verbose_name='app_config', to='aldryn_events.EventsConfig', null=True, on_delete=models.deletion.CASCADE,),
